...
const PointChargeOption = () => {
  ...
  const [chargeAmount, setChargeAmount] = useState<string | number>(""); // Initialize as an empty string
  ...
  const handlePaymentClick = () => {
    if (Number(chargeAmount) > 0 && isAgreed) {
      // Convert chargeAmount to number
      onClickPayment(Number(chargeAmount)); // Convert chargeAmount to number
    } else {
  ...
  //----------------------------------------------------------------
  const isButtonActive = Number(chargeAmount) > 0 && isAgreed;
  return (
    <div className={styles.ChargePointContainer}>
      <div className={styles.ChargePointTitle}>포인트 충전</div>
...
`}</pre>
      ...
      <div className={styles.subscribeInfo2}>
        <div className={styles.subTitle}>포인트 충전하기</div>
