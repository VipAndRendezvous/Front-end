...
const PointChargeOption = () => {
  ...
  useEffect(() => {
    // 컴포넌트 마운트 후 500ms 후에 애니메이션을 시작합니다.
    ...
    <div className={styles.membership}>
      <div
        className={`${styles.groupChild} ${
          isScrolled ? styles.darkenBackground : ""
        }`}
      />
      ...
      >
        <div className={styles.frameParent}>
          <div className={styles.varWrapper}>
            <div className={styles.highlightText}>VAR 멤버십</div>
          </div>
          <div className={styles.vipContainer}>
            <p className={styles.vip}>수많은 VIP 중</p>
            <p className={styles.vip}>인생의 멘토를 찾아보세요.</p>
          </div>
          <div className={styles.vipContainer1}>
            <p className={styles.vip}>
              당신의 VIP와 식사를 하며 그들의 이야기를 직접 들을 준비가
              되었나요?
            </p>
            <p className={styles.vip}>
        ...
        <div className={styles.SubscribeWrapper}>
          <div className={styles.SubscribeText}>구독하기</div>
          <img
            className={styles.SubscribeArrow}
            alt=""
            src="MembershipArrow.png"
          />
        </div>
      </div>

      <div
        className={`${styles.secPart} ${
          fadeEffect ? styles.fadeIn : styles.fadeOut
        }`}
      >
        <div className={styles.left}>
          ...
          <ul className={styles.leftSubTitle}>
            <li>VAR멤버십 요금은 월 5,900원 입니다.</li>
            <li>수많은 VIP가 진행하는 모든 경매에 참여할 수 있어요.</li>
            <li>직접 VIP가 되어 직접 경매를 주최할 수 있어요.</li>
          </ul>
        </div>
...
`}</pre>
          ...
          <div
            className={styles.membershipPayButton}
